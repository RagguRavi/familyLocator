...
class MainActivity : AppCompatActivity(), OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val permissionUtility = PermissionUtility(applicationContext, this)
        permissionUtility.askForPermissions()
...
/*        var myIntent = Intent(this, MyJobService::class.java)
                ...
                if (TextUtils.isEmpty(phoneText)) {
                    ...
                    if (matcher.matches()) {
                        ...
                        if (!isExist) {
                            ...
                            Snackbar.make(view, "Phone Number already added", Snackbar.LENGTH_SHORT)
                                .show()
